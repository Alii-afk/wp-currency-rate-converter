...
{
   wp_register_script(
    'crc-shortcode-script',
    CURRENCY_CONVERTER_PLUGIN_URL . 'js/crc-shortcode-script.js',
    array('jquery'),
    '7.0.1', // Custom version number
    true
);
...
?>
        <div class="sidebar sidebar-left" id="sidebar-left">
            <div style="display: grid; grid-template-columns: 20% 60% 20%; display:none; margin-bottom: 20px;" id="crc-close-btn-left">
                <span style=" display: flex; padding: 5px 20px;">
            ...
            <div id="q-item-left" style=" flex-direction: column; display: none;">
                <?php foreach ($currencies as $currency) : ?>
                    <div class="currency-option" data-currency-id="<?php echo $currency->id; ?>" data-side="left" onclick="handleCurrencyOptionClick('<?php echo $currency->currency_symbol; ?>', 'left-currency-id', 'vfrv',<?php echo $currency->id; ?>, '<?php echo $currency->currency_name; ?>', '<?php echo $currency->currency_logo; ?>', 'left')">
            ...
            <div data-v-4e76d53a="" class="home-banner__body">
                    ...
                    <div data-v-4e76d53a="" class="home-banner__block-body form-group">
                        <div data-v-4e76d53a="" class="dropdown">
                            <div data-v-4e76d53a="" class="form-field">
                                <input data-v-4e76d53a="" type="number" id="give_val" class="form-control form-control--value f-input" min="0" value="0" style="color: white; background: transparent; font-weight: bold; font-size: 16px;">
                ...
                <div data-v-4e76d53a="" class="home-banner__block">
                    ...
                    <div data-v-4e76d53a="" class="home-banner__block-body form-group">
                        <div data-v-4e76d53a="" class="dropdown">
                            <div data-v-4e76d53a="" class="form-field">
                                <input data-v-4e76d53a="" type="number" id="get_val" class="form-control text-bold form-control--value f-input" placeholder=""  value="0" style="color: white; background: transparent; font-weight: bold; font-size: 16px;" readonly>
